...
![](causact_AB_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
```
    ...
    ## disc_covc -0.61089    0.09784  -6.243 4.28e-10 ***
...
![](causact_AB_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->
...
Why did we use exponential(1) priors? Well we need positive numbers for
...
![](causact_AB_files/figure-gfm/unnamed-chunk-27-2.png)<!-- -->
...
![](causact_AB_files/figure-gfm/unnamed-chunk-28-1.png)<!-- -->
...
Next we’ll want to add back in the discrete covariate (but we will have
...
![](causact_AB_files/figure-gfm/unnamed-chunk-34-1.png)<!-- -->
...
Again, we can manipulate the drawsDF tibble to get anything we might
need
...
![](causact_AB_files/figure-gfm/unnamed-chunk-42-1.png)<!-- -->
...
![](causact_AB_files/figure-gfm/unnamed-chunk-43-1.png)<!-- -->
...
```
    ...
    ##  [1] causact_0.5.3    patchwork_1.1.2  ggridges_0.5.4   bayesplot_1.10.0
    ##  [5] lubridate_1.9.2  forcats_1.0.0    stringr_1.5.0    dplyr_1.1.2     
    ##  [9] purrr_1.0.2      readr_2.1.4      tidyr_1.3.0      tibble_3.2.1    
    ## [13] ggplot2_3.4.2    tidyverse_2.0.0 
    ## 
    ## loaded via a namespace (and not attached):
    ##  [1] jsonlite_1.8.7         posterior_1.4.1        distributional_0.3.2  
    ##  [4] highr_0.10             tensorA_0.36.2         yaml_2.3.7            
    ##  [7] pillar_1.9.0           backports_1.4.1        lattice_0.20-45       
    ## [10] glue_1.6.2             reticulate_1.31        digest_0.6.33         
    ## [13] RColorBrewer_1.1-3     checkmate_2.1.0        colorspace_2.1-0      
    ## [16] cowplot_1.1.1          htmltools_0.5.6        Matrix_1.5-3          
    ## [19] plyr_1.8.8             pkgconfig_2.0.3        DiagrammeR_1.0.10     
    ## [22] scales_1.2.1           marginaleffects_0.13.0 webshot_0.5.4         
    ## [25] processx_3.8.0         tzdb_0.4.0             timechange_0.2.0      
    ## [28] generics_0.1.3         farver_2.1.1           ellipsis_0.3.2        
    ## [31] withr_2.5.0            cli_3.6.1              magrittr_2.0.3        
    ## [34] evaluate_0.21          ps_1.7.4               fansi_1.0.4           
    ## [37] xml2_1.3.3             tools_4.2.2            data.table_1.14.8     
    ## [40] hms_1.1.3              lifecycle_1.0.3        V8_4.2.2              
    ## [43] munsell_0.5.0          callr_3.7.3            compiler_4.2.2        
    ## [46] rlang_1.1.1            grid_4.2.2             rstudioapi_0.15.0     
    ## [49] htmlwidgets_1.6.2      visNetwork_2.1.2       igraph_1.5.1          
    ## [52] labeling_0.4.2         rmarkdown_2.23         gtable_0.3.3          
    ## [55] curl_5.0.0             abind_1.4-5            reshape2_1.4.4        
    ## [58] R6_2.5.1               knitr_1.43             fastmap_1.1.1         
    ## [61] utf8_1.2.3             DiagrammeRsvg_0.1      insight_0.19.3        
    ## [64] stringi_1.7.12         Rcpp_1.0.11            vctrs_0.6.3           
    ## [67] png_0.1-8              tidyselect_1.2.0       xfun_0.40
